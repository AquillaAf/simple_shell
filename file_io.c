...
/**
 * ret_line - assigns the line variable for the 'get_line' funtion
 * @lnptr: pointer to the buffer that stores the input str
 * @lnsize: size of the lnptr buffer
 * @buf: string that is assigned to lnptr
 * @bsize: size of the buff
 * Return: void
 */
 ...
 * Return: the no of bytes read from the input
 */

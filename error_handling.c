 ...
 * @lschar: last character processed in the str
...
/**
 * print_syn_err - prints error msg when a syntax error is found
 * @dsh: data structure containing shell-related info
 * @str: input string to be checked
...
/**
 * chck_syn_err - function to find and print the syntax error

...
/**
 * cd_help_info - provides help info on the 'cd' command
 * Return: void
 */
...
/**
 * help_info - provides infor on the 'help' command
 * Return: void
 */
void help_info(void)
{
...
/**
 * gen_help_info - provides all user assitance on using the help command
 * Return: void
 */

...
/**
 * add_sep - adds a node to the end of the linked list
...
/**
 * add_var - adds a var at the end of the linked list
 * @head: pointer to the head of the linked list
 * @vlen: length of the var
 * @val: value of the var
 * @valen: length of the value
 * Return: address to the new head of the linked list
 */

...
/**
 * cd_cmd_err - generates error message for cd command
 * @dsh: pointer to the data struct
...
/**
 * cmd_not_found - generates a general error msg for a command not found
 * @dsh: pointer to the data struct
 * Return: pointer to the generated error msg
 */
...
/**
 * sh_exit_err - generates a generic error msg for shell exit error
 * @dsh: pointer to the data struct
 * Return: pointer to the generated error msg
 */
...
/**
 * env_err_msg - generates error msg for 'env'command
 * @dsh: pointer to the data struct
 * Return: error msg
 */
...
/**
 * path126_err_msg - generates error msg for the 'path' command
 * @dsh: pointer to the data struct

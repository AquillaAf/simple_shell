...
/**
 * struct data - structure containing runtime data for the shell program
 * @argv: the argument vector
 * @cmdline: command line input by the user
...
/**
 * struct sep_list_node - structure contains linked list to store separators
...
/**
 * struct cmdln_list_node - struct contains linked list storing command lines
...
/**
 * struct builtin_cmd - structure containing built-in commands

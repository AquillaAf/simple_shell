...
/**
 * print_env - prints the environ variables
 ...
 * @name: name of the environ variable to be found
 * @env_vars: pointer to the array of environ variables
...
/**
 * set_env - sets an environ variable
 * @name: name of environ variable to be set
 * @val: value to assign to the environ variable
 * @dsh: pointer to the data struct
 * Return: void
 */

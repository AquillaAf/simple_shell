...
/**
 * env_help_info - provides help inform for the 'env' command
 * Return: void
 */
...
/**
 * setenv_help_info - provides help info for the 'setenv' command
 * Return: void
 */
...
/**
 * unsetenv_help_info - provides help info for the 'unsetenv' command
 * Return: void
 */
...
/**
 * exit_help_info - provides help info for the 'exit' command
 * Return: void
 */
...
/**
 * alias_help_info - provides help info for the 'alias' command
 * Return: void
 */

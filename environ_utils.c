...
/**
 * cmp_env_var - compares environ variable names with the name passed
 * @envname: name of the environ variable
...
/**
 * cpy_env_info - copies info to create a new variable
 * @name: name of the environ variable
 * @val: value of the environ variable
...
/**
 * _setenv - sets the value of an environ variable or create
